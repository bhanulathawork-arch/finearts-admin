...
//   const variants = {
//     solid:
//       "bg-[#5426B8] text-white hover:bg-[#45209D] border border-[#5426B8]",
//     outline:
//       "bg-white text-[#5426B8] border border-[#5426B8] hover:bg-[#F5F1FF]",
//     white:
//       "bg-white text-[#5426B8] border border-white hover:bg-[#F5F1FF]",
//   };
...
//   if (Array.isArray(item?.schedule_days)) {
...
//               "
//             >
//               <FaClock className="text-[#F4B16A] text-[11px]" />
...
//               <FaCalendarWeek className="text-[#EE68E0]" />
...
//           >
//             <div className="flex items-center gap-2 text-sm text-white">
//               <FaCalendarAlt className="text-[#A842DF]" />
...
//       onClick={onClick}
//       className={[
//         "rounded-xl border bg-white px-5 py-6 text-center shadow-sm transition-all duration-200",
//         "hover:-translate-y-1 hover:shadow-md",
//         active
//           ? "border-[#5426B8] ring-2 ring-[#5426B8]/10"
//           : "border-gray-200",
//       ].join(" ")}
//     >
//       <div
...
//       const searchable =
//         `${title} ${subcategory} ${institute} ${trainer}`.toLowerCase();
...
//     "Discover the perfect classes and start your learning journey.";
...
//         <section className="relative overflow-hidden bg-[#1E114D]">
//           {bannerImage && (
//             <img
//               src={bannerImage}
//               alt={bannerTitle}
...
//               <p className="text-xs font-bold uppercase tracking-widest text-[#5426B8]">
//                 Categories
//               </p>
...
//         <section
//           id="classes-list"
//           className="bg-[#F7F5FF] py-12 sm:py-16"
//         >
//           <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
//             <div className="mb-8 text-center">
//               <p className="text-xs font-bold uppercase tracking-widest text-[#5426B8]">
...
//                   Showing{" "}
//                   <span className="font-bold text-[#5426B8]">
...
//                   No classes match your current search or
//                   category selection.
//                 </p>
...
//                 Choose your favorite class and begin your
...
//                 to right,
//                 ${branding.navbarColor}F5,
//                 ${branding.navbarColor}D9,
//                 ${branding.navbarColor}40
//               )`,
//             }}
//           />
...
//         {/* =================================================
//             HERO BANNER
//             Text removed: breadcrumb, title and description
//         ================================================= */}
...
//               background: `linear-gradient(
//                 to right,
//                 ${branding.navbarColor}35,
//                 ${branding.navbarColor}15,
//                 transparent
//               )`,
//             }}
//           />
